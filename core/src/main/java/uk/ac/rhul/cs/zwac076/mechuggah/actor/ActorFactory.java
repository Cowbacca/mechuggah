...
public class ActorFactory {
    ...
    private final class PowerUpPool extends Pool<PowerUp> {
        ...
        protected PowerUp newObject() {
            PowerUp powerUpActor = new PowerUp(null, 0, 0, 0, 0, intersectionChecker, null);
            return powerUpActor;
        }
    }
    ...
    public ActorFactory() {
        ...
        playerTexture = atlas.findRegion("newjelly_a");
     ...
     *            the width to make the background.
     * @param backgroundHeight
     *            the height to make the background.
     * 
     ...
     * 
     * @param x
     *            the x position to place the enemy at.
     * @param y
     *            the y position to place the enemy at.
    ...
    public Actor createPlayerActor(final int worldWidth, final CollisionDetectingStage stage) {
        ...
        final Player player = new Player(playerAnimation, (worldWidth / 2) - (playerAnimation.getWidth() / 2),
                ...
                playerAnimation.getHeight() / DEFAULT_PLAYER_HEIGHT_DIVISOR, defaultPlayerSpeed, intersectionChecker);
